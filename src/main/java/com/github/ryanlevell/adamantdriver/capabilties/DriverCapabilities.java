...
/**
 * Allows users to set additional browser capabilities.<p>
 * 
 * The class that implements this interface must be set via testng.xml or command line with key <b>CAPABILITIES_CLASS</b>
 * @author ryan
 *
 */
public interface DriverCapabilities {
	 ...
	 * @param browser The browser to set capabilities specific to browser being used.
	 * @param caps The capabilities object to add additional capabilities to.
